...
let {logger, DOCKER_IMAGE} = env.vars();
...
async function createContainer(session, containerName, timeout) {
    ...
    // setting timeout
    timeoutQ[containerName] = _timeoutContainer(containerName, timeout);
}
...
module.exports = {notebookRender, renderCell, getExamples, getNotebook, refreshEnv, createContainer};

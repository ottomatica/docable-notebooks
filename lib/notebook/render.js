            ...
            <div class="mb-2">
                <div class="d-flex flex-column card">
                    <div>
                        ...
                        <iframe class="w-100" style="height: 300px;" frameBorder="0" id="html_playground_preview_${elIDWithoutDash}"></iframe>
                    </div>
                </div>

                <script>
                const html_playground_content_${elIDWithoutDash} = document.getElementById('html_playground_content_${elIDWithoutDash}');
                const html_playground_preview_${elIDWithoutDash} = document.getElementById('html_playground_preview_${elIDWithoutDash}').contentWindow.document;
                ...
                require(['vs/editor/editor.main'], function () {
                    ...
                    let el_${elIDWithoutDash} = $('#${el.attr('id')}');
                    let text_from_${elIDWithoutDash} = el_${elIDWithoutDash}.find('code').html();
                    el_${elIDWithoutDash}.empty();
                    ...
                    window.html_playground_${elIDWithoutDash}.onDidChangeModelContent(() => {
                        html_playground_preview_${elIDWithoutDash}.open();
                        html_playground_preview_${elIDWithoutDash}.writeln(window.html_playground_${elIDWithoutDash}.getValue());
                        html_playground_preview_${elIDWithoutDash}.close();
                    });

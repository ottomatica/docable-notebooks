...
exports.secrets = async function(req, res) {
    res.render('secrets', { secrets: utils.getSecrets()});
}

exports.setSecret = async function(req, res) {

    utils.setSecret(req.body.slug, req.body.secret)
